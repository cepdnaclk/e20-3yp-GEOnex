...
/**
 * Exports survey points to a CSV file with proper formatting and metadata
 * @param {Array} points - Array of survey points with Latitude, Longitude, Name/Type properties
 * @param {string} filename - Output filename for the CSV file
 * @param {string} projectName - Name of the survey project
 * @param {boolean} includeHeader - Whether to include header and footer sections
 * @returns {string} - Path to the exported CSV file
 * @throws {Error} - If no points are provided or export fails
 */
...
module.exports = { exportToTxt, exportToDxf , exportToPdf, exportToCsv };
