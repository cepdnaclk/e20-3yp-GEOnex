...
const RemoteRoverEnable = () => {
    ...
    const [devices, setDevices] = useState([
        { id: 'ROVER_001', name: 'GEOnex Rover #1', status: 'online', battery: 85, enabled: false },
        { id: 'ROVER_002', name: 'GEOnex Rover #2', status: 'offline', battery: 42, enabled: false },
        { id: 'BASE_001', name: 'Base Station Alpha', status: 'online', battery: 100, enabled: true },
        { id: 'MOBILE_001', name: 'Mobile Unit Beta', status: 'busy', battery: 67, enabled: false }
    ]);
    ...
    return (
        <div className="bg-white p-5 rounded-lg flex flex-col gap-4 h-max">
            <h2 className="text-base md:text-lg font-semibold pb-2 border-b">Remote Client Devices</h2>
